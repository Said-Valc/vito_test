  ...
  <Container class="mb-6">
    <div class="mb-6">
      ...
      <p class="text-slate-600">
        После удаления вашей учетной записи все данные о ресурсах будут
        безвозвратно удалены. Это действие необратимо.
      </p>
    </div>
    ...
    <div v-if="showConfirmPassword">
      <form @submit.prevent="submit" class="flex items-end gap-4">
        ...
        <PrimaryBtn :disabled="form.processing">Подтвердить</PrimaryBtn>
